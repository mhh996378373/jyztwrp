...
TARGET_BOOTLOADER_BOARD_NAME := alps     # From ro.product.board
...
DEVICE_RESOLUTION := 1280*800                 # The Resolution of your Device
...
TARGET_USE_CUSTOM_LUN_FILE_PATH := /sys/devices/platform/soc/mt_usb/musb-hdrc.0.auto/gadget/lun%d/file
...
TARGET_BOARD_SUFFIX := _32                    # Remove if the device is 32-bit
